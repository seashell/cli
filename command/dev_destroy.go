...
func (c *DevDestroyCommand) Synopsis() string {
	return "Destroy a Seashell development environment"
}
...
func (c *DevDestroyCommand) Run(ctx context.Context, args []string) int {
	...
	c.UI.Info(fmt.Sprintf("==> Destroying development environment ..."))
...
func (c *DevDestroyCommand) parseConfig(args []string) *dev.Config {
...
func (c *DevDestroyCommand) parseFlags(flags *RootFlagSet, args []string) *dev.Config {
...
func (c *DevDestroyCommand) parseConfigFiles(paths ...string) *dev.Config {
...
func (c *DevDestroyCommand) parseEnv(paths ...string) *dev.Config {
...
Usage: seashell dev destroy [options]
	...
	Destroys a Seashell development environment.
